...
export const mockFacilityZones: FacilityZone[] = [
  {
    ...
    rules: ["Re-rack all plates after use", "Chalk permitted at designated stations only", "Ask before working in on occupied platforms"],
  ...
  },
  {
    ...
    operatingHours: "05:00 – 23:00 daily",
    rules: ["30-minute limit on cardio machines during peak hours", "Wipe down equipment after use", "Headphones required for audio"],
  ...
  },
  {
    ...
    rules: ["Shower before entering the plunge", "3-minute max per plunge session", "Sauna limited to 15 minutes per visit"],
  ...
  },
  {
    ...
    operatingHours: "05:00 – 23:00 daily",
    rules: ["Return kettlebells and sleds to their marked zones", "No chalk on turf", "Battle ropes must be coiled after use"],
  ...
  },
  {
    ...
    operatingHours: "06:00 – 22:00 daily",
    rules: ["Hand wraps required on all bag work", "Ring reserved for scheduled classes only", "No open-hand strikes on the heavy bags"],
  ...
  },
  {
    ...
    operatingHours: "05:00 – 23:00 daily",
    rules: ["Quiet hours enforced — no phone calls", "Return mats and props to storage", "Guided sessions take priority over drop-in use"],
